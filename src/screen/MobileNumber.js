...
import {Colors, ActivityIndicator, TextInput} from 'react-native-paper';
      ...
      <ScrollView>
        ...
        <View
          ...
          <View
            ...
            <Text
              ...
              code will be sent to Your number
            </Text>
          </View>
        </View>
          ...
          <View
            ...
            {statePackageCountryCodeShow == false ? (
              <TouchableOpacity
                ...
                <Text style={{color: COLORS.black000000}}>
                  {stateFirstCountryCode}
                </Text>
        ...
        <View style={{marginLeft: '40%'}}>
          {stateIsValidPhoneNo == false ? (
            <Text style={{color: 'red'}}>Enter Valid PhoneNo</Text>
          ) : null}
        </View>
